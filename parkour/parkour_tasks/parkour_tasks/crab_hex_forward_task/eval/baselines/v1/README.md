...
Produced by `scripts/run_gait_eval_suite.py --manifest eval/scenarios_v1.yaml` against
`eval/scenarios_v1.yaml`. Every later task (Task 1 reward shaping, Task 4 stage gates) is scored
...
`eval/scenarios_v1.yaml`'s header comment for the full note.
