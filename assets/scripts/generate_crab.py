...
VARIANT_NOTES = {
    ...
    "legacy_golden": "2026-08-20 measured-hardware build (splay 0, axes 5.5 in); every head before the a15b lineage",
...
def manifest_text() -> str:
    ...
    return (
        ...
        "2026-08-20 measured-hardware build (splay 0, axes 5.5 in) that every pre-a15b head was trained "
        "on. `assets/crab_simple.usda` is NOT in this table: it is the hand-authored Cube model of the "
        "2026-08-09 campaign baseline, kept as a historical reference and never generated. Select a plant "
