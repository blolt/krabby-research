...
// Every pin the firmware drives. A new pin assignment in board_pins.h belongs
// here too, or it is not checked for collisions.
...
// Only the revision selected by KRABBY_PIN_REV is checked; the others are not
