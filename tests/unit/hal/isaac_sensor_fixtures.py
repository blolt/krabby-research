...
ISAAC_CONFIGURED_SENSORS_FIXTURE: tuple[SensorInfo, ...] = (
    ...
    SensorInfo(
        ...
        camera_driver="isaac_scene",
        extra={
            "isaac_sensor_rgb": "side_right_rgb",
            "isaac_sensor_depth": "side_right_camera",
        },
    ),
    SensorInfo(
        id="side_right_rgbd_gray16_depth",
        type="depth",
        modality="depth",
        resolution=(640, 480),
        fps=30,
        ...
        extra={
            ...
            "gst_depth_source_catalog_id": "side_right_rgbd",
        },
    ),
    SensorInfo(
        id="side_left_rgbd",
        ...
        camera_driver="isaac_scene",
        extra={
            "isaac_sensor_rgb": "side_left_rgb",
            "isaac_sensor_depth": "side_left_camera",
        },
    ),
    SensorInfo(
        id="side_left_rgbd_gray16_depth",
        type="depth",
        modality="depth",
        resolution=(640, 480),
        fps=30,
        ...
        extra={
            "isaac_sensor_depth": "side_left_camera",
            "depth_range_m": (0.15, 1.5),
            "gst_depth_source_catalog_id": "side_left_rgbd",
        },
    ),
    SensorInfo(
        id="radar_front",
