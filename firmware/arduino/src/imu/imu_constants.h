...
static constexpr uint8_t IMU_BAD_TICKS_BEFORE_INVALID = 20;
...
static constexpr uint32_t LSM6DSO_BUS_TIMEOUT_MICROSECONDS = 10000UL;
...
static constexpr bool LSM6DSO_AUTO_INCREMENT = true;
static constexpr bool LSM6DSO_BLOCK_DATA_UPDATE = true;
