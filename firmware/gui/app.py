...
# IMU readout states (three-state model, see docs/M16-ERROR-HANDLING.md):
...
class KrabbyTestGUI(tk.Tk):
    ...
    def _poll_telemetry(self):
        ...
        if self._mcu.imu is not None:
            self._imu_var.set(IMU_READOUT_PREFIX + self._mcu.imu.format_compact())
