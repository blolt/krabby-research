...
└── experiments/                      # Campaigns (see below) + shared eval/, lit reviews, old-runs/, tools/
    ...
    ├── old-runs/<timestamp>/         # May-2026 bundled stage checkpoints with the pre-generator USD snapshot next to each (moved from <task>/runs/ 2026-09-09)
