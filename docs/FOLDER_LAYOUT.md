...
│
├── tests/                            # Test suite (pytest.ini at the root)
...
│   │                                 #   firmware/, teleop/, bench/, krabby/, data_collection/, fixtures/
...
- [lit-review-hexapod-reward-stability.md](lit-review-hexapod-reward-stability.md) -- literature review: reward design for hexapod stability.
- [lit-review-plasticity-cliff.md](lit-review-plasticity-cliff.md) -- literature review: the plasticity cliff at curriculum stage transitions.
- [lit-review-continuous-spin.md](lit-review-continuous-spin.md) -- literature review: the continuous-spin problem.
