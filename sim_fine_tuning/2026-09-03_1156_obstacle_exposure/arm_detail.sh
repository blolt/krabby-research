...
set -u
ARM="$1"; D=/home/nickmagus/krabby/krabby-research/sim_fine_tuning/2026-09-03_1156_obstacle_exposure
...
import json, sys
st = json.load(open("/home/nickmagus/krabby/krabby-research/sim_fine_tuning/2026-09-03_1156_obstacle_exposure/state.json"))
name = sys.argv[1]
...
spec = importlib.util.spec_from_file_location("rx", "/home/nickmagus/krabby/krabby-research/sim_fine_tuning/2026-09-03_1156_obstacle_exposure/run_exposure.py")
